...
def build_camp():
    ...
    ob.seed(camp, Start_Day=1, Coverage=0.5, Honor_Immunity=False,  Target_Props=["Region:Rural"])
    ob.seed(camp, Start_Day=365, Coverage=0.005, Tot_Rep=10, Rep_Interval=30, Honor_Immunity=False, Target_Props=["Region:Rural"])
    return camp
...
class TestHintCross(IntegrationTest):
    def setUp(self):
